...
";
	...
	public static $main_content_template = "{navigation-bar}
		...
		<footer>
			<p>{footer-message}</p>
			<p>Powered by Pepperminty Wiki v0.15, which was built by <a href='//starbeamrainbowlabs.com/'>Starbeamrainbowlabs</a>. Send bugs to 'bugs at starbeamrainbowlabs dot com' or <a href='//github.com/sbrl/Pepperminty-Wiki' title='Github Issue Tracker'>open an issue</a>.</p>
	...
	public static $minimal_content_template = "<main class='printable'>{content}</main>
		<footer class='printable'>
			...
			<p><em>Powered by Pepperminty Wiki v0.15.</em></p>
		</footer>";
